...
def get_train_args(
    ...
    if general_args.stage not in ["sft", "emb"] and training_args.predict_with_generate:
        raise ValueError("`predict_with_generate` cannot be set as True except SFT.")

    if general_args.stage in ["sft", "emb"] and training_args.do_predict and not training_args.predict_with_generate:
